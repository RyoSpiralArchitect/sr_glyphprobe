...
**Run:** `e1-social-token-isomorphic-exploratory-mlx--mlx--openai-community-gpt2--1a535759124aaaf5`  
**Backend:** `mlx`  
...
- Resolved layers: `[2, 4]`
- Median source-direction replicate alignment: 0.9761
- Median emoji fingerprint advantage over random controls: 0.7215
- Median within-target label-permutation screening p: n/a
- Cross-seed fingerprint advantage over random controls: 0.9955
...
- **PASS** `source_direction_stability`: 0.9761. Median source-direction replicate alignment >= 0.50.
...
- **PASS** `fingerprint_reproducibility`: 0.7215. Same-emoji held-out fingerprint similarity exceeds cross-emoji/random controls.
...
- **PASS** `cross_seed_output_stability`: 0.9955. Same-glyph cross-seed fingerprint separation exceeds the random-direction null.

Passed 9 of 11 gates.

## Highest fingerprint separations

- Layer 4, strength 0.050, seed 211: emoji separation 0.9666; random separation 0.0160; advantage 0.9506; label-permutation p n/a; repeated-split 95% interval [0.9147, 1.0586].
- Layer 2, strength 0.050, seed 211: emoji separation 0.8743; random separation 0.0471; advantage 0.8272; label-permutation p n/a; repeated-split 95% interval [0.5995, 0.9985].
- Layer 4, strength 0.050, seed 307: emoji separation 0.9552; random separation 0.1878; advantage 0.7674; label-permutation p n/a; repeated-split 95% interval [0.6597, 0.9966].
- Layer 2, strength 0.050, seed 101: emoji separation 0.6782; random separation 0.0027; advantage 0.6755; label-permutation p n/a; repeated-split 95% interval [0.6091, 0.9632].
- Layer 4, strength 0.050, seed 101: emoji separation 0.9089; random separation 1.9460; advantage -1.0371; label-permutation p n/a; repeated-split 95% interval [0.8381, 1.0367].
- Layer 2, strength 0.050, seed 307: emoji separation 0.6965; random separation 1.7961; advantage -1.0996; label-permutation p n/a; repeated-split 95% interval [0.6842, 0.9835].
