...
**Run:** `e1-sky-token-isomorphic-exploratory-mlx--mlx--openai-community-gpt2--39a274120fa8e6a1`  
**Backend:** `mlx`  
...
- Resolved layers: `[2, 4]`
- Median source-direction replicate alignment: 0.9754
- Median emoji fingerprint advantage over random controls: 0.8153
- Median within-target label-permutation screening p: n/a
- Cross-seed fingerprint advantage over random controls: 1.0129
...
- **PASS** `source_direction_stability`: 0.9754. Median source-direction replicate alignment >= 0.50.
...
- **PASS** `fingerprint_reproducibility`: 0.8153. Same-emoji held-out fingerprint similarity exceeds cross-emoji/random controls.
...
- **PASS** `cross_seed_output_stability`: 1.0129. Same-glyph cross-seed fingerprint separation exceeds the random-direction null.

Passed 9 of 11 gates.

## Highest fingerprint separations

- Layer 4, strength 0.050, seed 211: emoji separation 0.9551; random separation 0.0164; advantage 0.9388; label-permutation p n/a; repeated-split 95% interval [0.9279, 1.0643].
- Layer 4, strength 0.050, seed 307: emoji separation 1.0465; random separation 0.1685; advantage 0.8780; label-permutation p n/a; repeated-split 95% interval [0.8556, 1.0496].
- Layer 2, strength 0.050, seed 211: emoji separation 0.8980; random separation 0.0519; advantage 0.8461; label-permutation p n/a; repeated-split 95% interval [0.6765, 1.0157].
- Layer 2, strength 0.050, seed 101: emoji separation 0.7958; random separation 0.0114; advantage 0.7845; label-permutation p n/a; repeated-split 95% interval [0.6189, 0.9651].
- Layer 4, strength 0.050, seed 101: emoji separation 1.0651; random separation 1.9505; advantage -0.8854; label-permutation p n/a; repeated-split 95% interval [0.9415, 1.0777].
- Layer 2, strength 0.050, seed 307: emoji separation 0.7604; random separation 1.8099; advantage -1.0494; label-permutation p n/a; repeated-split 95% interval [0.7520, 1.0045].
