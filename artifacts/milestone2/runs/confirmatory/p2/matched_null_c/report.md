...
**Run:** `m2-p2-matched-null-c-mlx--mlx--openai-community-gpt2--586cbc8576607dea`  
**Backend:** `mlx`  
...
- Resolved layers: `[2, 4]`
- Median source-direction replicate alignment: 0.9724
...
- **PASS** `source_direction_stability`: 0.9724. Median source-direction replicate alignment >= 0.50.
...
- Layer 2, strength 0.050, seed 101: emoji separation 0.9232; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0416, 1.0416].
- Layer 2, strength 0.050, seed 211: emoji separation 1.0550; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9595, 0.9595].
- Layer 2, strength 0.050, seed 307: emoji separation 1.0182; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0134, 1.0134].
- Layer 4, strength 0.050, seed 101: emoji separation 1.0874; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0877, 1.0877].
- Layer 4, strength 0.050, seed 211: emoji separation 1.0759; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0892, 1.0892].
- Layer 4, strength 0.050, seed 307: emoji separation 0.9314; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9620, 0.9620].
