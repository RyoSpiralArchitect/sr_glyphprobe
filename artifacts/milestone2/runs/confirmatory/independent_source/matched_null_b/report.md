...
**Run:** `m2-p2-matched-null-b-independent-source-mlx--mlx--openai-community-gpt2--23db0b861df96b5e`  
**Backend:** `mlx`  
...
- Resolved layers: `[2, 4]`
- Median source-direction replicate alignment: 0.9890
...
- **PASS** `source_direction_stability`: 0.9890. Median source-direction replicate alignment >= 0.50.
...
- Layer 2, strength 0.050, seed 101: emoji separation 0.8498; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0540, 1.0540].
- Layer 2, strength 0.050, seed 211: emoji separation 0.9583; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9618, 0.9618].
- Layer 2, strength 0.050, seed 307: emoji separation 0.9736; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0339, 1.0339].
- Layer 4, strength 0.050, seed 101: emoji separation 0.9839; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0294, 1.0294].
- Layer 4, strength 0.050, seed 211: emoji separation 1.0145; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0611, 1.0611].
- Layer 4, strength 0.050, seed 307: emoji separation 1.0740; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [1.0300, 1.0300].
