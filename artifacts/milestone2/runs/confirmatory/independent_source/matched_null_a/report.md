...
**Run:** `m2-p2-matched-null-a-independent-source-mlx--mlx--openai-community-gpt2--3399aab5e0115243`  
**Backend:** `mlx`  
...
- Resolved layers: `[2, 4]`
- Median source-direction replicate alignment: 0.9888
...
- **PASS** `source_direction_stability`: 0.9888. Median source-direction replicate alignment >= 0.50.
...
- Layer 2, strength 0.050, seed 101: emoji separation 0.8495; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9645, 0.9645].
- Layer 2, strength 0.050, seed 211: emoji separation 0.8945; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9676, 0.9676].
- Layer 2, strength 0.050, seed 307: emoji separation 0.9621; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9712, 0.9712].
- Layer 4, strength 0.050, seed 101: emoji separation 0.9652; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.9202, 0.9202].
- Layer 4, strength 0.050, seed 211: emoji separation 0.9010; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.7750, 0.7750].
- Layer 4, strength 0.050, seed 307: emoji separation 0.8955; random separation n/a; advantage n/a; label-permutation p n/a; repeated-split 95% interval [0.8453, 0.8453].
