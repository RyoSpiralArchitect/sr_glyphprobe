...
**Run:** `colored-shapes-v1-standard-mlx--mlx--openai-community-gpt2--c493ae1e18743922`  
**Backend:** `mlx`  
...
- Median emoji fingerprint advantage over random controls: 0.6075
- Median within-target label-permutation screening p: 0.0010
- Cross-seed fingerprint advantage over random controls: 0.9308
...
- **PASS** `source_direction_stability`: 0.9705. Median source-direction replicate alignment >= 0.50.
...
- **PASS** `fingerprint_reproducibility`: 0.6075. Same-emoji held-out fingerprint similarity exceeds cross-emoji/random controls.
...
- **PASS** `cross_seed_output_stability`: 0.9308. Same-glyph cross-seed fingerprint separation exceeds the random-direction null.

Passed 11 of 11 gates.

## Highest fingerprint separations

- Layer 4, strength 0.100, seed 307: emoji separation 1.0224; random separation -1.4799; advantage 2.5023; label-permutation p 0.0010; repeated-split 95% interval [0.8565, 1.0531].
- Layer 7, strength 0.025, seed 307: emoji separation 1.0963; random separation 0.0817; advantage 1.0147; label-permutation p 0.0010; repeated-split 95% interval [1.0625, 1.1016].
- Layer 2, strength 0.100, seed 101: emoji separation 1.0516; random separation 0.0409; advantage 1.0106; label-permutation p 0.0010; repeated-split 95% interval [0.9573, 1.0547].
- Layer 2, strength 0.050, seed 101: emoji separation 1.0236; random separation 0.0376; advantage 0.9860; label-permutation p 0.0010; repeated-split 95% interval [0.9335, 1.0548].
- Layer 7, strength 0.050, seed 307: emoji separation 1.0918; random separation 0.1179; advantage 0.9739; label-permutation p 0.0010; repeated-split 95% interval [1.0352, 1.0996].
- Layer 4, strength 0.050, seed 211: emoji separation 1.0107; random separation 0.0424; advantage 0.9683; label-permutation p 0.0010; repeated-split 95% interval [0.8045, 1.0596].
- Layer 2, strength 0.100, seed 211: emoji separation 0.9776; random separation 0.0329; advantage 0.9446; label-permutation p 0.0010; repeated-split 95% interval [0.8930, 1.0530].
- Layer 4, strength 0.100, seed 211: emoji separation 0.9319; random separation 0.0291; advantage 0.9029; label-permutation p 0.0010; repeated-split 95% interval [0.7819, 1.0441].
- Layer 2, strength 0.025, seed 101: emoji separation 0.9464; random separation 0.0474; advantage 0.8991; label-permutation p 0.0010; repeated-split 95% interval [0.9121, 1.0541].
- Layer 2, strength 0.025, seed 211: emoji separation 0.9171; random separation 0.0491; advantage 0.8680; label-permutation p 0.0010; repeated-split 95% interval [0.8849, 1.0354].
